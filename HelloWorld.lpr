program CustomRCSTM32;




//debugging:
//-gw2 works well with gdb
//add lineinfo flag requires some units to be added in the project, may be a support folder will
//be added to this template, let's see...
//anyway the bin file increase a lot with this setting, not very useful on small flash size devices
...
//======================================================================
uses
   main, stm32f103fw, heapmgr, Arduino_compat, HWSPI;
...
//======================================================================
begin
   RegisterHeapBlock(pointer($20003500),$1500); //Heap config for STM32F103
    ...
    //on clock 72MHz and for a SysTick interrupt evey 1ms
    SystemTick:=0;
